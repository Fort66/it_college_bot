...
## 269. Что такое slicing в Python?
...
## 347. Компилируется ли Python? Если да, то как, если нет, то как выполняется.
...
## 348. Что означает __some_variable__ ?
...
## 390. Какие типы исключений генерируются в Python?
